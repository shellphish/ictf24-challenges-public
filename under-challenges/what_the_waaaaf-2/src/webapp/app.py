...
def login():
    ...
    # Cap the raw HTTP requesto to 10000 bytes
    ...
    if request.method == 'POST':
        ...
        # Calculate the MD5 of the received string
        #password_encoded = base64.b64encode(calculate_md5(password).encode('ascii')).decode("ascii")
        ...
        try:
            ...
            # (&(uid=*)(userPassword=*))(|(uid=*)(userPassword=*))
